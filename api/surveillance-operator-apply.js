...
const DEFAULT_POSITION = "Surveillance Operator";
...
function logApplicationIssue(label, error) {
  console.error(`[surveillance-operator-apply] ${label}`, {
...
function getApplicationErrorUrl(statusCode, message) {
  const url = new URL("https://jcit.digital/SurveillanceOperator/");
...
function buildInternalEmail({ fields, resumeFile }) {
  ...
  const rows = [
    ...
    ["Position", position],
    ["CCTV/VMS Tools", fields.tools_experience],
