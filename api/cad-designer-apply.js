...
function logApplicationIssue(label, error) {
  console.error(`[cad-designer-apply] ${label}`, {
...
function getApplicationErrorUrl(statusCode, message) {
  const url = new URL("https://jcit.digital/CADDesigner/");
...
function buildInternalEmail({ fields, resumeFile }) {
  ...
  const rows = [
    ...
    ["Position", position],
    ["Portfolio / Samples", fields.portfolio_link],
