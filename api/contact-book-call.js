...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (fields.company) {
      const location = String(fields._next || "https://jcit.digital/booking-confirmation/").trim();
    ...
    const nextUrl = String(fields._next || "https://jcit.digital/booking-confirmation/").trim();
    ...
    redirect(res, `https://jcit.digital/contact/?booking=error&message=${encodeURIComponent(message)}`);
  }
};
