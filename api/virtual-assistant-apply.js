...
const DEFAULT_POSITION = "Virtual Assistant";
...
function logApplicationIssue(label, error) {
  console.error(`[virtual-assistant-apply] ${label}`, {
...
function getApplicationErrorUrl(statusCode, message) {
  const url = new URL("https://jcit.digital/VirtualAssistant/");
...
function buildInternalEmail({ fields, resumeFile }) {
  ...
  const rows = [
    ...
    ["Position", position],
    ["Tools Experience", fields.tools_experience],
